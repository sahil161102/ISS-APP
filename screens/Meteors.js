...
import { Text, View, Alert, SafeAreaView, Platform,StyleSheet, FlatList, StatusBar,ImageBackground,Image,Dimensions } from 'react-native';
        ...
        if (Object.keys(this.state.meteors).length === 0) {
            ...
            return (
                ...
                <SafeAreaView styles = {styles.safeArea}/>
                    <FlatList renderItem ={this.renderItem} data = {meteors} horizontal = {true} keyExtractor = {this.keyExtractor}/>
                </View>
            )
        }
    }
